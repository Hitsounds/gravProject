...
class SimConfig(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        "general":{
            ...
            "timestep":["Timestep Ratio","numInput",tk.StringVar()]
        },
        "bodies":[]
        }
    ...
    def construct_optionmenu(self):
        ...
        for i in range(0, len(self.settings["bodies"])):
            menu.add_command(label=f"Body {i}", command=partial(self.render_bodysettings, f"{i}"))
    ...
    def add_body(self):
        ...
        #body template
        body_template = {
                "mass":["Mass (kg)","numInput",tk.StringVar()],
                "inital_x_pos":["x Position (m)","numInput",tk.StringVar()],
                "inital_y_pos":["y Position (m)","numInput",tk.StringVar()],
                "inital_x_speed":["x Speed (m/s)","numInput",tk.StringVar()],
                "inital_y_speed":["y Speed (m/s)","numInput",tk.StringVar()]
        }  
        #defaults
    ...
    def render_bodysettings(self, i):
        ...
        massInput.configure(validatecommand=(massInput.register(self.floatValidation), "%P"))
        ...
        x_PosInput.grid(row=1, column=1)
        ...
        y_PosInput.grid(row=2, column=1)
        ...
        x_SpeedInput.grid(row=3, column=1)
        ...
        y_SpeedInput.grid(row=4, column=1)
